...
let AdminController = class AdminController {
    ...
    async requestVerificationOtp(requestDto) {
        return this.adminService.requestAdminVerificationOTP(requestDto);
    }
    async verifyOtp(verifyAdminOtpDto) {
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: admin_dto_1.CreateFeeConfigurationDto }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Fee configuration created successfully' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [admin_dto_1.CreateFeeConfigurationDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, admin_dto_1.UpdateFeeConfigurationDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Post)('request-verification-otp'),
    (0, roles_decorator_1.Roles)('ADMIN', 'SUPER_ADMIN'),
    (0, swagger_1.ApiTags)('Admin - Verification'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'User is not an admin' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Admin user not found' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [admin_dto_1.RequestAdminVerificationDto]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "requestVerificationOtp", null);
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid, expired, or already used OTP code, or user is not an admin' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Admin user not found' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [admin_dto_1.VerifyAdminOtpDto]),
    __metadata("design:returntype", Promise)
