...
exports.seedStripePaymentMethods = seedStripePaymentMethods;
...
async function seedStripePaymentMethods(dataSource) {
    const repository = dataSource.getRepository(stripe_payment_method_entity_1.StripePaymentMethod);
    ...
    console.log('\n✅ Stripe payment methods seeding completed!\n');
    return { created, updated, skipped, total: stripePaymentMethods.length };
}
if (require.main === module) {
    Promise.resolve().then(() => require('../config/typeorm.config')).then(async (module) => {
        ...
        try {
            ...
            await seedStripePaymentMethods(AppDataSource);
...
//# sourceMappingURL=seed-stripe-payment-methods.js.map