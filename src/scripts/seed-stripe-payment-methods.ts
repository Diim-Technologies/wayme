...
// Comprehensive list of Stripe payment methods as of 2024
...
export async function seedStripePaymentMethods(dataSource: DataSource) {
    const repository = dataSource.getRepository(StripePaymentMethod);
...
if (require.main === module) {
    import('../config/typeorm.config').then(async (module) => {
        ...
        // Enable synchronize to create table if it doesn't exist
