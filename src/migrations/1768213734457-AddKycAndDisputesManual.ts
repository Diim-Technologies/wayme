...
export class AddKycAndDisputesManual1768213734457 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Add foreign keys (using character varying columns)
